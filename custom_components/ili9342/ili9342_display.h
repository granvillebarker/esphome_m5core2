...
#include "ili9342_defines.h"
#include "ili9342_init.h"
...
class ILI9342Display : public PollingComponent,
 ...
 public:
  ...
  void set_model(ILI9342Model model) { this->model_ = model; }
...
//-----------   M5Stack display --------------
class ILI9342M5Stack : public ILI9342Display {
 public:
  void initialize() override;
};

//-----------   ILI9342_24_TFT display --------------
class ILI9342TFT24 : public ILI9342Display {
 public:
  void initialize() override;
};
}  // namespace ili9342
